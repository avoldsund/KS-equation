...
\begin{abstract}
The Kuramoto-Sivashinsky equation has been solved by using an explicit method and an implicit-explicit method. The stability for the schemes have been explored both theoretically and numerically. The explicit was shown to be unstable for $\frac{k}{h^4} < \frac{1}{8}$, while the implicit-explicit method proved better stability. \end{abstract}

\section{Introduction}
\input{introduction}

\section{Difference schemes}
\input{differenceSchemes}
